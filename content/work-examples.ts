...
export const workExamples: WorkExample[] = [
  ...
  },
  {
    ...
    summary: "An independently owned IT service business serving 108 clients, specializing in technical support, system optimization, and performance tuning.",
    tech: ["Windows", "Hardware", "Networking", "System Optimization"],
    description: [
      "AlphaBiz is an independently owned IT service business I founded and operated, focused on delivering hands on technical support and performance optimization solutions to a diverse client base. Over the course of building the business, I worked directly with 108 clients, diagnosing and resolving a wide range of hardware and software issues. These included custom PC assembly, operating system recovery, driver troubleshooting, and system instability caused by conflicting components or configurations. Each project required a tailored approach, balancing technical precision with clear communication to ensure clients understood both the problem and the solution.",
      "In addition to technical execution, I managed every aspect of business operations from the ground up. This included pricing strategy, service packaging, customer acquisition, and long term client relationship management. Within the first two years, AlphaBiz generated $4,148 in revenue, achieved without external funding or partnerships. This experience strengthened my ability to operate independently, make data driven decisions, and maintain a high standard of service while scaling workload efficiently. I also developed strong client trust through consistent delivery, transparency, and responsiveness.",
